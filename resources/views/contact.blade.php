		...
		<div class="card my-5 shadow">
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-6">
					...
					<form class="form mx-3 mb-5 mt-3" action="" method="">
						...
						<div class="form-group">
							<input type="submit" name="submit" class="btn btn-outline-info" value="Send" style="width: 100%; height:50px; font-size:20px;">
						</div>
					</form>
				</div>
			</div>
