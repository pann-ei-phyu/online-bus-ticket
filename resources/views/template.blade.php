...
<body>
	...
	<nav class="navbar navbar-expand-lg bg-light navbar-light py-3 shadow fixed-top">
		<div class="container">
			<a href="index.html" class="navbar-brand" style="font-family: 'Cinzel Decorative', cursive; font-weight: bold; font-size: 30px; color:  #e74c3c ;"><img src="{{asset('mm-bus-ticket/image/logo1.jfif')}}" id="logo" class="mr-4">Online MM Ticket</a>
			...
			<div id="myNav" class="collapse navbar-collapse">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item"><a class="nav-link" href="{{route('contacts.create')}}">CONTACT</a></li>
				</ul>
			</div>
		</div>
	</nav>
